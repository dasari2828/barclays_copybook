...
public class GenHiveCreateTable {
  public static void main(String[] args) throws Exception {
    ...
    for (ExternalField field : externalRecord.getRecordFields()) {
        System.out.println(field.getDescription() + "_" + field.getParameter() + "_" + field.getSubKey());
      if (isFirst) {
        isFirst = false;
      } else {
        writer.append(",");
      ...
      if (type == Type.ftChar) {
        ...
        hiveType = "DOUBLE";  
      } else if(type == Type.ftNumZeroPaddedPositive){
          typeString = "ftNumZeroPaddedPositive";
          hiveType = "BIGINT";
      }
